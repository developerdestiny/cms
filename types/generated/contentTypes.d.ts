...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nombre_agencia: Attribute.String & Attribute.Required;
...
export interface ApiMondaMonda extends Schema.CollectionType {
...
export interface ApiServicioServicio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    fecha_de_incio: Attribute.Date & Attribute.Required;
    fecha_fin: Attribute.Date;
    group_size: Attribute.BigInteger & Attribute.Required;
    tipo_servicio: Attribute.Relation<
      'api::servicio.servicio',
      'manyToOne',
    ...
    galeria: Attribute.Media & Attribute.Required;
    url_wetravel: Attribute.String & Attribute.Required;
    incluido: Attribute.DynamicZone<['items.item-incluido']>;
    no_incluido: Attribute.DynamicZone<['items.item-incluido']>;
    preguntas_frecuentes: Attribute.DynamicZone<
      ['preguntas-frecuentes.pregunta']
    >;
    duracion: Attribute.String & Attribute.Required;
...
export interface ApiTipoServicioTipoServicio extends Schema.CollectionType {
